...
class QuickAnswerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (botKeyboardView != null) {
            if (msg.keyboard != null && msg.keyboard.inline && msg.keyboard.buttons.size > 0) {
                botKeyboardView.visibility = View.VISIBLE
                botKeyboardView.setButtons(msg.keyboard.buttons, false)
            } else {
        ...
        val hasAttachments =
            msg.fwd.nonNullNoEmpty() || msg.attachments != null && msg.attachments.size() > 0
        ...
        if (hasAttachments) {
            ...
            attachmentsViewBinder.setVoiceActionListener(object : VoiceActionListener {
                ...
                override fun onVoicePlayButtonClick(
                    ...
                    val audio = Audio().setId(voiceMessage.id).setOwnerId(voiceMessage.ownerId)
                        .setTitle(voiceMessage.id.toString() + "_" + voiceMessage.ownerId)
                        .setArtist("Voice")
