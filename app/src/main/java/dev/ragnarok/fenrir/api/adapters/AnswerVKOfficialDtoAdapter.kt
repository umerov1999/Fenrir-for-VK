        ...
        if (hasArray(root, "profiles")) {
            ...
            for (i in temp) {
                ...
                if (obj.has("photo_200")) {
                    ...
                    dtolist.fields.add(AnswerField(id, url))
