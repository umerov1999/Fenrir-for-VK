...
import dev.ragnarok.fenrir.adapter.BigVkPhotosAdapter.UploadActionListener
...
class VKPhotosFragment : BaseMvpFragment<VkPhotosPresenter, IVkPhotosView>(),
    BigVkPhotosAdapter.PhotosActionListener, UploadActionListener, IVkPhotosView {
    ...
    override fun showSelectPhotosToast() {
        Toast.makeText(
            requireActivity(),
            getString(R.string.select_attachments),
            Toast.LENGTH_SHORT
        ).show()
    }
    ...
    private fun startLocalPhotosSelectionActibity() {
