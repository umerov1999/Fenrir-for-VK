...
class UserWallFragment : AbsWallFragment<IUserWallView, UserWallPresenter>(), IUserWallView {
    ...
    override fun openProducts(accountId: Int, ownerId: Int, owner: Owner?) {
        getMarketPlace(accountId, ownerId, 0).tryOpenWith(requireActivity())
    }
    ...
    private inner class UserHeaderHolder(root: View) {
        ...
        val blacklisted: ImageView = root.findViewById(R.id.item_blacklisted)
        ...
        val bProducts: TextView = root.findViewById(R.id.fragment_user_profile_bproducts)
        ...
        init {
            ...
            root.findViewById<View>(R.id.header_user_profile_products_container)
                .setOnClickListener {
