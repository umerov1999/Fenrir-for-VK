...
class StoryPagerPresenter(
    ...
    private fun downloadImpl() {
        ...
        if (story.video != null) {
            ...
            story.video.title = story.owner.fullName
            if (!url.isNullOrEmpty()) {
                doDownloadVideo(context, story.video, url, "Story")
            }
        }
    }
    ...
    private fun doSaveOnDrive(photo: Story) {
        ...
        DownloadResult(makeLegalFilename(photo.owner.fullName, null), dir, photo.photo)
    }
