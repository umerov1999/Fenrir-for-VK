...
class MessengerContentProvider : ContentProvider() {
    companion object {
        ...
        init {
            ...
            sMessagesAttachmentsProjectionMap[MessagesAttachmentsColumns.TYPE] =
                MessagesAttachmentsColumns.FULL_TYPE
            ...
            sPostsMessagesAttachmentsProjectionMap[WallAttachmentsColumns.TYPE] =
                WallAttachmentsColumns.FULL_TYPE
            ...
            sCommentsMessagesAttachmentsProjectionMap[CommentsAttachmentsColumns.TYPE] =
                CommentsAttachmentsColumns.FULL_TYPE
            ...
            sNoticationsProjectionMap[NotificationColumns.TYPE] =
                NotificationColumns.FULL_TYPE
            sNoticationsProjectionMap[NotificationColumns.DATE] =
                NotificationColumns.FULL_DATE
            sNoticationsProjectionMap[NotificationColumns.DATA] = NotificationColumns.FULL_DATA
    ...
    override fun update(
        ...
        val db: SQLiteDatabase = getDbHelper(uri).writableDatabase
        val cnt: Int = db.update(tbName, values, selection, selectionArgs)
        safeNotifyChange(uri)
