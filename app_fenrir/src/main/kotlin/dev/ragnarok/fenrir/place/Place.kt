...
open class Place : Parcelable {
    ...
    companion object {
        ...
        const val COMMUNITY_CONTROL = 53
        const val COMMUNITY_BAN_EDIT = 54
        const val COMMUNITY_ADD_BAN = 55
        const val COMMUNITY_MANAGER_EDIT = 56
        const val COMMUNITY_MANAGER_ADD = 57
        const val REQUEST_EXECUTOR = 58
        const val USER_BLACKLIST = 59
        const val PROXY_ADD = 60
        const val DRAWER_EDIT = 61
        const val SIDE_DRAWER_EDIT = 62
        const val BOTTOM_DRAWER_EDIT = 63
        ...
        const val AUTH_BY_CODE = 101
        const val FEED_OWNER_LIST = 102
        const val FEED_OWNERS = 103
        const val REACTED_PEERS = 104
