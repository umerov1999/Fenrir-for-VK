...
class CatalogV2ListEditFragment :
    ...
    ICatalogV2ListEditView, MenuProvider {
    private var mAdapter: CatalogV2ListEditAdapter? = null
    ...
    override fun onCreateView(
        ...
        mAdapter = CatalogV2ListEditAdapter(emptyList())
    ...
    override fun onResume() {
        ...
        if (actionBar != null) {
            actionBar.setTitle(R.string.catalog_v2_edit_list)
    ...
    companion object {
        fun newInstance(): CatalogV2ListEditFragment {
            val args = Bundle()
            val fragment = CatalogV2ListEditFragment()
