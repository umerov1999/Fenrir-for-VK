...
class AspectRatioAnimatedShapeableImageView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null
) : AnimatedShapeableImageView(context, attrs) {
    ...
    companion object {
        // NOTE: These must be kept in sync with the AspectRatioAnimatedShapeableImageView attributes in attrs.xml.
