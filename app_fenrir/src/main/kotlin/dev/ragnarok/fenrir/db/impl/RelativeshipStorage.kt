    ...
    companion object {
        ...
        internal fun mapDbo(cursor: Cursor): UserEntity {
            ...
            return UserEntity(gid)
                ...
                .setCanWritePrivateMessage(cursor.getBoolean(RelationshipColumns.FOREIGN_SUBJECT_WRITE_MESSAGE_STATUS))
                .setBdate(cursor.getString(RelationshipColumns.FOREIGN_SUBJECT_BDATE))
                .setBlacklisted_by_me(cursor.getBoolean(RelationshipColumns.FOREIGN_SUBJECT_IS_USER_BLACK_LIST))
                .setBlacklisted(cursor.getBoolean(RelationshipColumns.FOREIGN_SUBJECT_IS_BLACK_LISTED))
                .setCan_access_closed(cursor.getBoolean(RelationshipColumns.FOREIGN_SUBJECT_IS_CAN_ACCESS_CLOSED))
                .setVerified(cursor.getBoolean(RelationshipColumns.FOREIGN_SUBJECT_IS_VERIFIED))
                .setMaiden_name(cursor.getString(RelationshipColumns.FOREIGN_SUBJECT_MAIDEN_NAME))
        }
    }
}