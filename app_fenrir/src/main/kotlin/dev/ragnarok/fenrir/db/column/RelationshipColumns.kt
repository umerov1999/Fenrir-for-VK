...
object RelationshipColumns : BaseColumns {
    ...
    const val FOREIGN_SUBJECT_WRITE_MESSAGE_STATUS = "subject_write_message_status"
    const val FOREIGN_SUBJECT_BDATE = "subject_bdate"
    const val FOREIGN_SUBJECT_IS_USER_BLACK_LIST = "subject_is_user_in_black_list"
    const val FOREIGN_SUBJECT_IS_BLACK_LISTED = "subject_is_black_listed"
    const val FOREIGN_SUBJECT_IS_CAN_ACCESS_CLOSED = "subject_is_can_access_closed"
    const val FOREIGN_SUBJECT_IS_VERIFIED = "subject_is_verified"
    const val FOREIGN_SUBJECT_MAIDEN_NAME = "subject_maiden_name"
