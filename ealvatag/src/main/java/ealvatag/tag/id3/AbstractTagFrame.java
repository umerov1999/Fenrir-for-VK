 ...
 * <p>
 * Description: This class represents 'parts of tags'. It contains methods that they all use use. ID3v2 tags have frames. Lyrics3 tags have
 * fields. ID3v1 tags do not have parts. It also contains their header while the body contains the actual fragments.
 */
...
public abstract class AbstractTagFrame extends AbstractTagItem {
    ...
    public boolean isSubsetOf(Object obj) {
        ...
        return frameBody.isSubsetOf(((AbstractTagFrame) obj).frameBody);
