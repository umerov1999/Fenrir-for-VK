...
/**
 * Lead artist(s)/Lead performer(s)/Soloist(s)/Performing group Text information frame. <p>The 'Lead artist(s)/Lead
 * performer(s)/Soloist(s)/Performing group' is used for the main artist(s). They are seperated with the "/" character.
 * <p>
...
public class FrameBodyTPE1 extends AbstractFrameBodyTextInfo implements ID3v24FrameBody, ID3v23FrameBody {
    ...
    public FrameBodyTPE1(Buffer byteBuffer, int frameSize) throws InvalidTagException {
        super(byteBuffer, frameSize);
    }
