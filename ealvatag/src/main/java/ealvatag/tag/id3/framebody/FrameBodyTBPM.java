...
/**
 * Beats Per Minute Text information frame. <p>The 'BPM' frame contains the number of beats per minute in the mainpart of the audio. The BPM
 * is an integer and represented as a numerical string.
 * <p>
...
public class FrameBodyTBPM extends AbstractFrameBodyTextInfo implements ID3v24FrameBody, ID3v23FrameBody {
    ...
    public FrameBodyTBPM(Buffer byteBuffer, int frameSize) throws InvalidTagException {
        super(byteBuffer, frameSize);
    }
