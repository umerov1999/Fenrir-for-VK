...
public class FrameBodyASPI extends AbstractID3v2FrameBody implements ID3v24FrameBody {
    ...
    public FrameBodyASPI(Buffer byteBuffer, int frameSize) throws InvalidTagException {
        super(byteBuffer, frameSize);
    }
    ...
    protected void setupObjectList() {
        addDataType(new NumberFixedLength(INDEXED_DATA_START, this, DATA_START_FIELD_SIZE));
        addDataType(new NumberFixedLength(INDEXED_DATA_LENGTH, this, DATA_LENGTH_FIELD_SIZE));
        addDataType(new NumberFixedLength(NUMBER_OF_INDEX_POINTS, this, NO_OF_INDEX_POINTS_FIELD_SIZE));
        addDataType(new NumberFixedLength(BITS_PER_INDEX_POINT, this, BITS_PER_INDEX_POINTS_FIELD_SIZE));
        addDataType(new NumberVariableLength(FRACTION_AT_INDEX, this, FRACTION_AT_INDEX_MINIMUM_FIELD_SIZE));
    }
}
