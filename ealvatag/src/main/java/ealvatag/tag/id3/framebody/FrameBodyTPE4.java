...
/**
 * Interpreted, remixed, or otherwise modified by Text information frame. <p>The 'Interpreted, remixed, or otherwise modified by' frame
...
public class FrameBodyTPE4 extends AbstractFrameBodyTextInfo implements ID3v24FrameBody, ID3v23FrameBody {
    ...
    public FrameBodyTPE4(Buffer byteBuffer, int frameSize) throws InvalidTagException {
        super(byteBuffer, frameSize);
    }
