...
/**
 * Internet radio station owner Text information frame. <p>The 'Internet radio station owner' frame contains the name of the owner of the
...
public class FrameBodyTRSO extends AbstractFrameBodyTextInfo implements ID3v23FrameBody, ID3v24FrameBody {
    ...
    public FrameBodyTRSO(Buffer byteBuffer, int frameSize) throws InvalidTagException {
        super(byteBuffer, frameSize);
    }
