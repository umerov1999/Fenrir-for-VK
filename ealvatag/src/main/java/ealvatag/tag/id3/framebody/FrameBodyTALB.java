...
/**
 * Album/Movie/Show title Text information frame. <p>The 'Album/Movie/Show title' frame is intended for the title of the recording(/source
 * of sound) which the audio in the file is taken from.
 * <p>
...
public class FrameBodyTALB extends AbstractFrameBodyTextInfo implements ID3v24FrameBody, ID3v23FrameBody {
    ...
    public FrameBodyTALB(Buffer buffer, int frameSize) throws InvalidTagException {
