...
/**
 * Recording dates Text information frame. <p>The 'Recording dates' frame is a intended to be used as complement to the "TYER", "TDAT" and
 * "TIME" frames. E.g. "4th-7th June, 12th June" in combination with the "TYER" frame.
 * <p>
...
public class FrameBodyTRDA extends AbstractFrameBodyTextInfo implements ID3v23FrameBody {
    ...
    public FrameBodyTRDA(Buffer byteBuffer, int frameSize) throws InvalidTagException {
        super(byteBuffer, frameSize);
    }
