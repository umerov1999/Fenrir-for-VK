...
/**
 * Lyricist/Text writer Text information frame. <p>The 'Lyricist(s)/Text writer(s)' frame is intended for the writer(s) of the text or
...
public class FrameBodyTEXT extends AbstractFrameBodyTextInfo implements ID3v24FrameBody, ID3v23FrameBody {
    ...
    public FrameBodyTEXT(Buffer byteBuffer, int frameSize) throws InvalidTagException {
        super(byteBuffer, frameSize);
    }
