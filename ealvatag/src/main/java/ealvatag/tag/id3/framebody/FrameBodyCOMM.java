...
//  private static final String ITUNES_NORMALIZATION = "iTunNORM";
...
//  }
    ...
    public FrameBodyCOMM(Buffer byteBuffer, int frameSize) throws InvalidTagException {
        super(byteBuffer, frameSize);
    }
