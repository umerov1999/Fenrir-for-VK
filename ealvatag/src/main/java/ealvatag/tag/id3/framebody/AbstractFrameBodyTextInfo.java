...
public abstract class AbstractFrameBodyTextInfo extends AbstractID3v2FrameBody {
     ...
     *
     * @param textEncoding Specifies what encoding should be used to write text to file.
    ...
    protected AbstractFrameBodyTextInfo(Buffer buffer, int frameSize) throws InvalidTagException {
