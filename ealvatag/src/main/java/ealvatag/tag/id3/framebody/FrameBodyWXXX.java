 ...
 * <p>
 * Description: Represents a user defined URL,must also privide a description
 */
...
public class FrameBodyWXXX extends AbstractFrameBodyUrlLink implements ID3v24FrameBody, ID3v23FrameBody {
    ...
    public FrameBodyWXXX(Buffer byteBuffer, int frameSize) throws InvalidTagException {
        super(byteBuffer, frameSize);
    }
