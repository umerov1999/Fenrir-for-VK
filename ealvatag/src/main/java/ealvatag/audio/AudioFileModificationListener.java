...
public interface AudioFileModificationListener {
     ...
     * @param temporary The modified copy. (It may be of zero size if the original was modified)
     * @throws ModifyVetoException If the Results doesn't fit the expectations of the listener, it can prevent the replacement of the
     *                             original by temporary.<br> If the original is already modified, this exception results in nothing.
     */
     ...
     * @param delete <code>true</code> if the deletion of tag data will be performed.
