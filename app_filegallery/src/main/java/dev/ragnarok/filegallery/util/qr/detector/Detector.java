...
import dev.ragnarok.filegallery.util.qr.BitMatrix;
import dev.ragnarok.filegallery.util.qr.DecodeHintType;
import dev.ragnarok.filegallery.util.qr.DefaultGridSampler;
import dev.ragnarok.filegallery.util.qr.DetectorResult;
import dev.ragnarok.filegallery.util.qr.FormatException;
import dev.ragnarok.filegallery.util.qr.MathUtils;
import dev.ragnarok.filegallery.util.qr.NotFoundException;
import dev.ragnarok.filegallery.util.qr.PerspectiveTransform;
import dev.ragnarok.filegallery.util.qr.ResultPoint;
import dev.ragnarok.filegallery.util.qr.ResultPointCallback;
import dev.ragnarok.filegallery.util.qr.decoder.Version;
...
public class Detector {
    ...
    private static BitMatrix sampleGrid(BitMatrix image,
        ...
        return DefaultGridSampler.sampleGrid(image, dimension, dimension, transform);
    }
