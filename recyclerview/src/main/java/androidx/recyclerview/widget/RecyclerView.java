...
public class RecyclerView extends ViewGroup implements ScrollingView,
    ...
    private void beginDragTrace() {
        if (!mIsTracingDrag) {
            Trace.beginAsyncSection("RecyclerView#drag", System.identityHashCode(this));
            mIsTracingDrag = true;
        }
    }
    ...
    private void endDragTrace() {
        if (mIsTracingDrag) {
            Trace.endAsyncSection("RecyclerView#drag", System.identityHashCode(this));
    ...
    private void requestChildOnScreen(@NonNull View child, @Nullable View focused) {
        ...
        if (focusedLayoutParams instanceof LayoutParams lp) {
    ...
    public abstract static class Adapter<VH extends ViewHolder> {
        ...
        boolean canRestoreState() {
            return switch (mStateRestorationPolicy) {
                case PREVENT -> false;
                case PREVENT_WHEN_EMPTY -> getItemCount() > 0;
                default -> true;
            };
        }
    ...
    public abstract static class LayoutManager {
        ...
        private static boolean isMeasurementUpToDate(int childSize, int spec, int dimension) {
            ...
            return switch (specMode) {
                case MeasureSpec.UNSPECIFIED -> true;
                case MeasureSpec.AT_MOST -> specSize >= childSize;
                case MeasureSpec.EXACTLY -> specSize == childSize;
                default -> false;
            };
        }
    ...
    public abstract static class ItemAnimator {
        ...
        public static class ItemHolderInfo {
             ...
             */
            public @NonNull ItemHolderInfo setFrom(RecyclerView.@NonNull ViewHolder holder) {
