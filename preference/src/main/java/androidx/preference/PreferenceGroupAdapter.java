...
public class PreferenceGroupAdapter extends RecyclerView.Adapter<PreferenceViewHolder>
    ...
    void updatePreferences() {
        ...
        List<Preference> oldVisibleList = mVisiblePreferences;
        ...
        List<Preference> visiblePreferenceList = createVisiblePreferencesList(
                mPreferenceGroup);
        ...
        if (preferenceManager != null
            ...
            PreferenceManager.PreferenceComparisonCallback comparisonCallback =
     ...
     */
    private ExpandButton createExpandButton(PreferenceGroup group,
