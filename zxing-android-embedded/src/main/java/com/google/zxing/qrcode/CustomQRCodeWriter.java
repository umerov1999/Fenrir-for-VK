...
public class CustomQRCodeWriter {
    ...
    public @Nullable
    Bitmap encode(@NonNull String contents, int width, int height, @Nullable Drawable icon) {
        try {
    ...
    public @Nullable
    Bitmap encode(@NonNull String contents, int width, int height, @Nullable Map<EncodeHintType, ?> hints, @Nullable Drawable icon) throws WriterException {
