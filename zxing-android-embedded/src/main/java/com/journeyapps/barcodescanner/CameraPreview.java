...
public class CameraPreview extends ViewGroup {
    ...
    private final RotationCallback rotationCallback = new RotationCallback() {
        @Override
    ...
    protected void initializeAttributes(AttributeSet attrs) {
        @SuppressLint("CustomViewStyleable") TypedArray styledAttributes = getContext().obtainStyledAttributes(attrs, R.styleable.zxing_camera_preview);
